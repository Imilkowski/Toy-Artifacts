...
function InitializeItemTables()
    ...
    table.insert(decorationItems, ItemToBuy.new(4, 250))
    table.insert(decorationItems, ItemToBuy.new(6, 500))
    table.insert(decorationItems, ItemToBuy.new(8, 500))
    table.insert(decorationItems, ItemToBuy.new(5, 500))
    table.insert(decorationItems, ItemToBuy.new(3, 1000))
    table.insert(decorationItems, ItemToBuy.new(7, 1000))
    table.insert(decorationItems, ItemToBuy.new(9, 1000))
end
